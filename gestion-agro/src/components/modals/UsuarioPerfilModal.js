...
export default function UsuarioPerfilModal({ rowData = [],  modalData=false, handleAddRow, handleUpdateRow }) {


  const getPost = (submitValues) => {
    return {
      usp_usuario: submitValues.usp_usuario,
      usp_perfil: submitValues.usp_perfil,
      usp_estado: submitValues.status
    }
  }
  ...
  const formSchema = Yup.object().shape({
    usp_usuario: Yup.number().required('Campo Requerido'),
    usp_perfil: Yup.number().required("campo requerido"),
  ...
  return (
    <Container component="main" maxWidth="md" className={classes.modal}>
      ...
      <Formik
        initialValues={{
          usp_usuario: rowData?.usp_usuario,
          usp_perfil: rowData?.usp_perfil,
          status: rowData?.usp_estado || 0,
        }}
            ...
            <Grid container spacing={2} >
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  id="usp_usuario"
                  label="usp_usuario"
                  value={values.usp_usuario || ''}
                  onChange={handleChange}
                  onBlur={handleBlur}
                  error={errors.usp_usuario && touched.usp_usuario}
                  helperText={errors.usp_usuario}
                />
              </Grid>
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  name="usp_perfil"
                  autoComplete="lname"
                  value={values.usp_perfil || ''}
                  onChange={handleChange}
                  onBlur={handleBlur}
                  error={errors.usp_perfil && touched.usp_perfil}
                  helperText={errors.usp_perfil}
                />
              </Grid>
